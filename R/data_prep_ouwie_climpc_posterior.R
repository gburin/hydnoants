## here::i_am("R/data_prep_ouwie_climpc.R")
...
#### Differences
app.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "app", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.app)),
                                      paste0("alpha", 1:length(states.app)),
                                      paste0("sigma", 1:length(states.app)))]
...
agg.app.diff.pc1 <- aggregate(app.plot.diff.pc1[, (4 + 3*length(states.app)):ncol(app.plot.diff.pc1)], by = list(app.plot.diff.pc1$trait, app.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
app.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "app",
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.app)),
                                      paste0("alpha", 1:length(states.app)),
                                      paste0("sigma", 1:length(states.app)))]
...
agg.app.diff.pc2 <- aggregate(app.plot.diff.pc2[, (4 + 3*length(states.app)):ncol(app.plot.diff.pc2)], by = list(app.plot.diff.pc2$trait, app.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
app.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "app", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.app)),
                                      paste0("alpha", 1:length(states.app)),
                                      paste0("sigma", 1:length(states.app)))]
...
agg.app.diff.pc3 <- aggregate(app.plot.diff.pc3[, (4 + 3*length(states.app)):ncol(app.plot.diff.pc3)], by = list(app.plot.diff.pc3$trait, app.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
arch.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "arch", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.arch)),
                                      paste0("alpha", 1:length(states.arch)),
                                      paste0("sigma", 1:length(states.arch)))]
...
agg.arch.diff.pc1 <- aggregate(arch.plot.diff.pc1[, (4 + 3*length(states.arch)):ncol(arch.plot.diff.pc1)], by = list(arch.plot.diff.pc1$trait, arch.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
arch.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "arch", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.arch)),
                                      paste0("alpha", 1:length(states.arch)),
                                      paste0("sigma", 1:length(states.arch)))]
...
agg.arch.diff.pc2 <- aggregate(arch.plot.diff.pc2[, (4 + 3*length(states.arch)):ncol(arch.plot.diff.pc2)], by = list(arch.plot.diff.pc2$trait, arch.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
arch.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "arch", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.arch)),
                                      paste0("alpha", 1:length(states.arch)),
                                      paste0("sigma", 1:length(states.arch)))]
...
agg.arch.diff.pc3 <- aggregate(arch.plot.diff.pc3[, (4 + 3*length(states.arch)):ncol(arch.plot.diff.pc3)], by = list(arch.plot.diff.pc3$trait, arch.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
domgrow.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "domgrow", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.domgrow)),
                                      paste0("alpha", 1:length(states.domgrow)),
                                      paste0("sigma", 1:length(states.domgrow)))]
...
agg.domgrow.diff.pc1 <- aggregate(domgrow.plot.diff.pc1[, (4 + 3*length(states.domgrow)):ncol(domgrow.plot.diff.pc1)], by = list(domgrow.plot.diff.pc1$trait, domgrow.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
domgrow.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "domgrow", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.domgrow)),
                                      paste0("alpha", 1:length(states.domgrow)),
                                      paste0("sigma", 1:length(states.domgrow)))]
...
agg.domgrow.diff.pc2 <- aggregate(domgrow.plot.diff.pc2[, (4 + 3*length(states.domgrow)):ncol(domgrow.plot.diff.pc2)], by = list(domgrow.plot.diff.pc2$trait, domgrow.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
domgrow.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "domgrow", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.domgrow)),
                                      paste0("alpha", 1:length(states.domgrow)),
                                      paste0("sigma", 1:length(states.domgrow)))]
...
agg.domgrow.diff.pc3 <- aggregate(domgrow.plot.diff.pc3[, (4 + 3*length(states.domgrow)):ncol(domgrow.plot.diff.pc3)], by = list(domgrow.plot.diff.pc3$trait, domgrow.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
leafstruc.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "leafstruc", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.leafstruc)),
                                      paste0("alpha", 1:length(states.leafstruc)),
                                      paste0("sigma", 1:length(states.leafstruc)))]
...
agg.leafstruc.diff.pc1 <- aggregate(leafstruc.plot.diff.pc1[, (4 + 3*length(states.leafstruc)):ncol(leafstruc.plot.diff.pc1)], by = list(leafstruc.plot.diff.pc1$trait, leafstruc.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
agg.leafstruc.diff.pc2 <- aggregate(leafstruc.plot.diff.pc2[, (4 + 3*length(states.leafstruc)):ncol(leafstruc.plot.diff.pc2)], by = list(leafstruc.plot.diff.pc2$trait, leafstruc.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
agg.leafstruc.diff.pc3 <- aggregate(leafstruc.plot.diff.pc3[, (4 + 3*length(states.leafstruc)):ncol(leafstruc.plot.diff.pc3)], by = list(leafstruc.plot.diff.pc3$trait, leafstruc.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
matsys.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "matsys", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.matsys)),
                                      paste0("alpha", 1:length(states.matsys)),
                                      paste0("sigma", 1:length(states.matsys)))]
...
agg.matsys.diff.pc1 <- aggregate(matsys.plot.diff.pc1[, (4 + 3*length(states.matsys)):ncol(matsys.plot.diff.pc1)], by = list(matsys.plot.diff.pc1$trait, matsys.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
matsys.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "matsys", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.matsys)),
                                      paste0("alpha", 1:length(states.matsys)),
                                      paste0("sigma", 1:length(states.matsys)))]
...
agg.matsys.diff.pc2 <- aggregate(matsys.plot.diff.pc2[, (4 + 3*length(states.matsys)):ncol(matsys.plot.diff.pc2)], by = list(matsys.plot.diff.pc2$trait, matsys.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
matsys.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "matsys", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.matsys)),
                                      paste0("alpha", 1:length(states.matsys)),
                                      paste0("sigma", 1:length(states.matsys)))]
...
agg.matsys.diff.pc3 <- aggregate(matsys.plot.diff.pc3[, (4 + 3*length(states.matsys)):ncol(matsys.plot.diff.pc3)], by = list(matsys.plot.diff.pc3$trait, matsys.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
reward.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "reward", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.reward)),
                                      paste0("alpha", 1:length(states.reward)),
                                      paste0("sigma", 1:length(states.reward)))]
...
agg.reward.diff.pc1 <- aggregate(reward.plot.diff.pc1[, (4 + 3*length(states.reward)):ncol(reward.plot.diff.pc1)], by = list(reward.plot.diff.pc1$trait, reward.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
reward.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "reward", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.reward)),
                                      paste0("alpha", 1:length(states.reward)),
                                      paste0("sigma", 1:length(states.reward)))]
...
agg.reward.diff.pc2 <- aggregate(reward.plot.diff.pc2[, (4 + 3*length(states.reward)):ncol(reward.plot.diff.pc2)], by = list(reward.plot.diff.pc2$trait, reward.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
reward.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "reward", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.reward)),
                                      paste0("alpha", 1:length(states.reward)),
                                      paste0("sigma", 1:length(states.reward)))]
...
agg.reward.diff.pc3 <- aggregate(reward.plot.diff.pc3[, (4 + 3*length(states.reward)):ncol(reward.plot.diff.pc3)], by = list(reward.plot.diff.pc3$trait, reward.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
strategy.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "strategy", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.strategy)),
                                      paste0("alpha", 1:length(states.strategy)),
                                      paste0("sigma", 1:length(states.strategy)))]
...
agg.strategy.diff.pc1 <- aggregate(strategy.plot.diff.pc1[, (4 + 3*length(states.strategy)):ncol(strategy.plot.diff.pc1)], by = list(strategy.plot.diff.pc1$trait, strategy.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
strategy.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "strategy", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.strategy)),
                                      paste0("alpha", 1:length(states.strategy)),
                                      paste0("sigma", 1:length(states.strategy)))]
...
agg.strategy.diff.pc2 <- aggregate(strategy.plot.diff.pc2[, (4 + 3*length(states.strategy)):ncol(strategy.plot.diff.pc2)], by = list(strategy.plot.diff.pc2$trait, strategy.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
strategy.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "strategy", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.strategy)),
                                      paste0("alpha", 1:length(states.strategy)),
                                      paste0("sigma", 1:length(states.strategy)))]
...
agg.strategy.diff.pc3 <- aggregate(strategy.plot.diff.pc3[, (4 + 3*length(states.strategy)):ncol(strategy.plot.diff.pc3)], by = list(strategy.plot.diff.pc3$trait, strategy.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
warts.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "warts", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.warts)),
                                      paste0("alpha", 1:length(states.warts)),
                                      paste0("sigma", 1:length(states.warts)))]
...
agg.warts.diff.pc1 <- aggregate(warts.plot.diff.pc1[, (4 + 3*length(states.warts)):ncol(warts.plot.diff.pc1)], by = list(warts.plot.diff.pc1$trait, warts.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
warts.plot.diff.pc2 <- pars.table.pc2[pars.table.pc2$disc.trait == "warts", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.warts)),
                                      paste0("alpha", 1:length(states.warts)),
                                      paste0("sigma", 1:length(states.warts)))]
...
agg.warts.diff.pc2 <- aggregate(warts.plot.diff.pc2[, (4 + 3*length(states.warts)):ncol(warts.plot.diff.pc2)], by = list(warts.plot.diff.pc2$trait, warts.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
warts.plot.diff.pc3 <- pars.table.pc3[pars.table.pc3$disc.trait == "warts", 
                                    c("trait", "simmap", "disc.trait",
                                      paste0("theta", 1:length(states.warts)),
                                      paste0("alpha", 1:length(states.warts)),
                                      paste0("sigma", 1:length(states.warts)))]
...
agg.warts.diff.pc3 <- aggregate(warts.plot.diff.pc3[, (4 + 3*length(states.warts)):ncol(warts.plot.diff.pc3)], by = list(warts.plot.diff.pc3$trait, warts.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)
...
#### Differences
holediam.disc.plot.diff.pc1 <- pars.table.pc1[pars.table.pc1$disc.trait == "holediam.disc", 
                                    c("trait", "simmap", "disc.trait",
...
for(i in 1:length(states.holediam.disc)){
    for(j in 1:length(states.holediam.disc)){
        holediam.disc.plot.diff.pc1[, paste0("theta", i, j)] <- holediam.disc.plot.diff.pc1[, paste0("theta", i)] > holediam.disc.plot.diff.pc1[, paste0("theta", j)]
        holediam.disc.plot.diff.pc1[, paste0("alpha", i, j)] <- holediam.disc.plot.diff.pc1[, paste0("alpha", i)] > holediam.disc.plot.diff.pc1[, paste0("alpha", j)]
        holediam.disc.plot.diff.pc1[, paste0("sigma", i, j)] <- holediam.disc.plot.diff.pc1[, paste0("sigma", i)] > holediam.disc.plot.diff.pc1[, paste0("sigma", j)]
    }
}

agg.holediam.disc.diff.pc1 <- aggregate(holediam.disc.plot.diff.pc1[, (4 + 3*length(states.holediam.disc)):ncol(holediam.disc.plot.diff.pc1)], by = list(holediam.disc.plot.diff.pc1$trait, holediam.disc.plot.diff.pc1$disc.trait), FUN = sum, na.rm = TRUE)

for(i in 1:length(agg.holediam.disc.diff.pc1$Group.1)){
    assign(paste0("holediam.disc.diff.theta.pc1.", gsub(" ", ".", agg.holediam.disc.diff.pc1$Group.1[i])), as.data.frame(matrix(as.numeric(unlist(agg.holediam.disc.diff.pc1[i, grep("theta", names(agg.holediam.disc.diff.pc1))])), ncol = length(states.holediam.disc), nrow = length(states.holediam.disc), byrow = TRUE), row.names = states.holediam.disc))
    assign(paste0("holediam.disc.diff.alpha.pc1.", gsub(" ", ".", agg.holediam.disc.diff.pc1$Group.1[i])), as.data.frame(matrix(as.numeric(unlist(agg.holediam.disc.diff.pc1[i, grep("alpha", names(agg.holediam.disc.diff.pc1))])), ncol = length(states.holediam.disc), nrow = length(states.holediam.disc), byrow = TRUE), row.names = states.holediam.disc))
    assign(paste0("holediam.disc.diff.sigma.pc1.", gsub(" ", ".", agg.holediam.disc.diff.pc1$Group.1[i])), as.data.frame(matrix(as.numeric(unlist(agg.holediam.disc.diff.pc1[i, grep("sigma", names(agg.holediam.disc.diff.pc1))])), ncol = length(states.holediam.disc), nrow = length(states.holediam.disc), byrow = TRUE), row.names = states.holediam.disc))
}
...
agg.holediam.disc.diff.pc2 <- aggregate(holediam.disc.plot.diff.pc2[, (4 + 3*length(states.holediam.disc)):ncol(holediam.disc.plot.diff.pc2)], by = list(holediam.disc.plot.diff.pc2$trait, holediam.disc.plot.diff.pc2$disc.trait), FUN = sum, na.rm = TRUE)
...
agg.holediam.disc.diff.pc3 <- aggregate(holediam.disc.plot.diff.pc3[, (4 + 3*length(states.holediam.disc)):ncol(holediam.disc.plot.diff.pc3)], by = list(holediam.disc.plot.diff.pc3$trait, holediam.disc.plot.diff.pc3$disc.trait), FUN = sum, na.rm = TRUE)

...
agg.app.diff.pc2 <- aggregate(app.plot.diff.pc2[, (4 + 3*length(states.app)):ncol(app.plot.diff.pc2)], by = list(app.plot.diff.pc2$trait, app.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.app.diff.pc3 <- aggregate(app.plot.diff.pc3[, (4 + 3*length(states.app)):ncol(app.plot.diff.pc3)], by = list(app.plot.diff.pc3$trait, app.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.arch.diff.pc1 <- aggregate(arch.plot.diff.pc1[, (4 + 3*length(states.arch)):ncol(arch.plot.diff.pc1)], by = list(arch.plot.diff.pc1$trait, arch.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.arch.diff.pc2 <- aggregate(arch.plot.diff.pc2[, (4 + 3*length(states.arch)):ncol(arch.plot.diff.pc2)], by = list(arch.plot.diff.pc2$trait, arch.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.arch.diff.pc3 <- aggregate(arch.plot.diff.pc3[, (4 + 3*length(states.arch)):ncol(arch.plot.diff.pc3)], by = list(arch.plot.diff.pc3$trait, arch.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.domgrow.diff.pc1 <- aggregate(domgrow.plot.diff.pc1[, (4 + 3*length(states.domgrow)):ncol(domgrow.plot.diff.pc1)], by = list(domgrow.plot.diff.pc1$trait, domgrow.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.domgrow.diff.pc2 <- aggregate(domgrow.plot.diff.pc2[, (4 + 3*length(states.domgrow)):ncol(domgrow.plot.diff.pc2)], by = list(domgrow.plot.diff.pc2$trait, domgrow.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.domgrow.diff.pc3 <- aggregate(domgrow.plot.diff.pc3[, (4 + 3*length(states.domgrow)):ncol(domgrow.plot.diff.pc3)], by = list(domgrow.plot.diff.pc3$trait, domgrow.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.leafstruc.diff.pc1 <- aggregate(leafstruc.plot.diff.pc1[, (4 + 3*length(states.leafstruc)):ncol(leafstruc.plot.diff.pc1)], by = list(leafstruc.plot.diff.pc1$trait, leafstruc.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.leafstruc.diff.pc2 <- aggregate(leafstruc.plot.diff.pc2[, (4 + 3*length(states.leafstruc)):ncol(leafstruc.plot.diff.pc2)], by = list(leafstruc.plot.diff.pc2$trait, leafstruc.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.leafstruc.diff.pc3 <- aggregate(leafstruc.plot.diff.pc3[, (4 + 3*length(states.leafstruc)):ncol(leafstruc.plot.diff.pc3)], by = list(leafstruc.plot.diff.pc3$trait, leafstruc.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.matsys.diff.pc1 <- aggregate(matsys.plot.diff.pc1[, (4 + 3*length(states.matsys)):ncol(matsys.plot.diff.pc1)], by = list(matsys.plot.diff.pc1$trait, matsys.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.matsys.diff.pc2 <- aggregate(matsys.plot.diff.pc2[, (4 + 3*length(states.matsys)):ncol(matsys.plot.diff.pc2)], by = list(matsys.plot.diff.pc2$trait, matsys.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.matsys.diff.pc3 <- aggregate(matsys.plot.diff.pc3[, (4 + 3*length(states.matsys)):ncol(matsys.plot.diff.pc3)], by = list(matsys.plot.diff.pc3$trait, matsys.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.reward.diff.pc1 <- aggregate(reward.plot.diff.pc1[, (4 + 3*length(states.reward)):ncol(reward.plot.diff.pc1)], by = list(reward.plot.diff.pc1$trait, reward.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.reward.diff.pc2 <- aggregate(reward.plot.diff.pc2[, (4 + 3*length(states.reward)):ncol(reward.plot.diff.pc2)], by = list(reward.plot.diff.pc2$trait, reward.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.reward.diff.pc3 <- aggregate(reward.plot.diff.pc3[, (4 + 3*length(states.reward)):ncol(reward.plot.diff.pc3)], by = list(reward.plot.diff.pc3$trait, reward.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.strategy.diff.pc1 <- aggregate(strategy.plot.diff.pc1[, (4 + 3*length(states.strategy)):ncol(strategy.plot.diff.pc1)], by = list(strategy.plot.diff.pc1$trait, strategy.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.strategy.diff.pc2 <- aggregate(strategy.plot.diff.pc2[, (4 + 3*length(states.strategy)):ncol(strategy.plot.diff.pc2)], by = list(strategy.plot.diff.pc2$trait, strategy.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.strategy.diff.pc3 <- aggregate(strategy.plot.diff.pc3[, (4 + 3*length(states.strategy)):ncol(strategy.plot.diff.pc3)], by = list(strategy.plot.diff.pc3$trait, strategy.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.warts.diff.pc1 <- aggregate(warts.plot.diff.pc1[, (4 + 3*length(states.warts)):ncol(warts.plot.diff.pc1)], by = list(warts.plot.diff.pc1$trait, warts.plot.diff.pc1$disc.trait), FUN = sum)
...
agg.warts.diff.pc2 <- aggregate(warts.plot.diff.pc2[, (4 + 3*length(states.warts)):ncol(warts.plot.diff.pc2)], by = list(warts.plot.diff.pc2$trait, warts.plot.diff.pc2$disc.trait), FUN = sum)
...
agg.warts.diff.pc3 <- aggregate(warts.plot.diff.pc3[, (4 + 3*length(states.warts)):ncol(warts.plot.diff.pc3)], by = list(warts.plot.diff.pc3$trait, warts.plot.diff.pc3$disc.trait), FUN = sum)
...
agg.holediam.disc.diff.pc1 <- aggregate(holediam.disc.plot.diff.pc1[, (4 + 3*length(states.holediam.disc)):ncol(holediam.disc.plot.diff.pc1)], by = list(holediam.disc.plot.diff.pc1$trait, holediam.disc.plot.diff.pc1$disc.trait), FUN = sum)
